 ...
 "cells": [
  {
   ...
   "metadata": {
    "ExecuteTime": {
     "end_time": "2021-07-19T13:56:09.329899Z",
     "start_time": "2021-07-19T13:56:09.277864Z"
    },
    "code_folding": [
     0
    ]
  ...
  },
  {
   ...
   "metadata": {
    "ExecuteTime": {
     "end_time": "2021-07-19T13:56:10.587143Z",
     "start_time": "2021-07-19T13:56:10.568139Z"
    },
    "code_folding": [
     0
    ]
  ...
  },
  {
   ...
   "metadata": {
    "ExecuteTime": {
     "end_time": "2021-07-19T23:37:58.113074Z",
     "start_time": "2021-07-19T23:37:58.055061Z"
    }
   },
   "outputs": [
    {
     "data": {
      "text/plain": [
       "{66707599984: 'Conservador',\n",
       " 55695397315: 'Conservador',\n",
       " 63743886918: 'Conservador',\n",
       " 55941368774: 'Conservador',\n",
       " 75486280874: 'Conservador',\n",
       " 53164949799: 'Conservador',\n",
       " 39898704131: 'Conservador',\n",
       " 53740901207: 'Conservador',\n",
       " 51735950236: 'Conservador',\n",
       " 47305108951: 'Conservador',\n",
       " 63858864633: 'Conservador',\n",
       " 53363167240: 'Conservador',\n",
       " 72133754195: 'Conservador',\n",
       " 52802483512: 'Conservador',\n",
       " 57925287214: 'Conservador',\n",
       " 74354632224: 'Conservador',\n",
       " 64020216626: 'Conservador',\n",
       " 78223722856: 'Conservador',\n",
       " 58245228846: 'Conservador',\n",
       " 74490686776: 'Conservador',\n",
       " 48646824781: 'Conservador',\n",
       " 77381458676: 'Conservador',\n",
       " 41615431874: 'Conservador',\n",
       " 52163844491: 'Conservador',\n",
       " 70276304567: 'Conservador',\n",
       " 69119828185: 'Conservador',\n",
       " 65441690046: 'Conservador',\n",
       " 56457227894: 'Conservador',\n",
       " 46939428126: 'Conservador',\n",
       " 60979942480: 'Conservador',\n",
       " 41648583220: 'Conservador',\n",
       " 50376331791: 'Conservador',\n",
       " 67008801023: 'Conservador',\n",
       " 72149193419: 'Conservador',\n",
       " 62830733382: 'Conservador',\n",
       " 56716675811: 'Conservador',\n",
       " 61089667146: 'Conservador',\n",
       " 47795509468: 'Conservador',\n",
       " 60899885693: 'Conservador',\n",
       " 53433670705: 'Conservador',\n",
       " 54850120580: 'Moderado',\n",
       " 71457789994: 'Moderado',\n",
       " 67692777563: 'Moderado',\n",
       " 43133573182: 'Moderado',\n",
       " 55150612815: 'Moderado',\n",
       " 48211725243: 'Moderado',\n",
       " 76686463776: 'Moderado',\n",
       " 71971000560: 'Moderado',\n",
       " 40307235992: 'Moderado',\n",
       " 44826533081: 'Moderado',\n",
       " 45735414894: 'Agressivo',\n",
       " 57137146514: 'Moderado',\n",
       " 53657058251: 'Agressivo',\n",
       " 52941460485: 'Moderado',\n",
       " 44306600683: 'Moderado',\n",
       " 43460747924: 'Moderado',\n",
       " 75590376075: 'Moderado',\n",
       " 68267282206: 'Moderado',\n",
       " 77567920298: 'Moderado',\n",
       " 67600419504: 'Moderado',\n",
       " 44902189811: 'Moderado',\n",
       " 62966866614: 'Moderado',\n",
       " 56182108880: 'Moderado',\n",
       " 78299785392: 'Agressivo',\n",
       " 45206071878: 'Moderado',\n",
       " 57381925887: 'Moderado',\n",
       " 65654934891: 'Moderado',\n",
       " 56130640481: 'Moderado',\n",
       " 59667611672: 'Moderado',\n",
       " 40349334385: 'Moderado',\n",
       " 68422640081: 'Moderado',\n",
       " 55245923439: 'Moderado',\n",
       " 51286696873: 'Moderado',\n",
       " 41065279767: 'Moderado',\n",
       " 42866454119: 'Moderado',\n",
       " 61962944542: 'Moderado',\n",
       " 48623501235: 'Moderado',\n",
       " 49475220139: 'Moderado',\n",
       " 52245218531: 'Moderado',\n",
       " 50932926697: 'Moderado',\n",
       " 47432932248: 'Agressivo',\n",
       " 39321991579: 'Agressivo',\n",
       " 46283759608: 'Agressivo',\n",
       " 56996272538: 'Agressivo',\n",
       " 77232189978: 'Agressivo',\n",
       " 77183282421: 'Agressivo',\n",
       " 42857147573: 'Moderado',\n",
       " 39331584043: 'Agressivo',\n",
       " 48130345228: 'Agressivo',\n",
       " 71422443953: 'Agressivo',\n",
       " 72508507904: 'Agressivo',\n",
       " 41188727558: 'Agressivo',\n",
       " 61358776640: 'Agressivo',\n",
       " 66934042323: 'Agressivo',\n",
       " 40622495567: 'Agressivo',\n",
       " 57221661311: 'Agressivo',\n",
       " 45159362930: 'Agressivo',\n",
       " 45018975174: 'Agressivo',\n",
       " 70685429140: 'Agressivo',\n",
       " 61808723477: 'Agressivo',\n",
       " 56363906548: 'Agressivo',\n",
       " 39646194720: 'Agressivo',\n",
       " 55385494438: 'Agressivo',\n",
       " 75796138061: 'Moderado',\n",
       " 53595767857: 'Agressivo',\n",
       " 48758828080: 'Agressivo',\n",
       " 58387651356: 'Agressivo',\n",
       " 72846931192: 'Agressivo',\n",
       " 47046896346: 'Agressivo',\n",
       " 69730292799: 'Agressivo',\n",
       " 48177836349: 'Agressivo',\n",
       " 57976326635: 'Agressivo',\n",
       " 55710813002: 'Agressivo',\n",
       " 64028580439: 'Agressivo',\n",
       " 49962942971: 'Agressivo',\n",
       " 47250893163: 'Agressivo',\n",
       " 75559276274: 'Agressivo',\n",
       " 58529878272: 'Agressivo',\n",
       " 76005896622: 'Agressivo',\n",
       " 49212614633: 'Agressivo'}"
      ]
     },
     "execution_count": 86,
     "metadata": {},
   ...
   "source": [
    "classificar_investidor = Knn_classificacao(data, no_class, 0, 1, 2)\n",
    "#classificar_investidor.dist_eucl(no_class[0])\n",
    "#classificar_investidor.classificar_um(no_class[0], 3)\n",
    "classificar_investidor.classificar_todos(3)"
   ]
  }
 ],
 "metadata": {
